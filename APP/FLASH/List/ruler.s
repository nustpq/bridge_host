///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.3.6832/W32 for ARM       06/Jun/2014  17:56:47
...
Setup_Audio:
        ...
        CMP      R0,#+0
        BNE      ??Setup_Audio_1
        LDR      R3,??DataTable11_7
        B        ??Setup_Audio_2
??Setup_Audio_1:
        LDR      R3,??DataTable11_8
??Setup_Audio_2:
        LDRB     R2,[R4, #+3]
        LDRH     R1,[R4, #+0]
...
??Save_Ruler_FW_0:
        ...
        B        ??Save_Ruler_FW_4
??Save_Ruler_FW_3:
        ADR      R0,??DataTable20_2  ;; 0x3E, 0x20, 0x00, 0x00
        BL       BSP_Ser_Printf
        LDR      R0,[SP, #+0]
        CMP      R0,#+170
        BEQ      ??Save_Ruler_FW_5
...
??Toggle_Mic_0:
        ...
        CMP      R0,#+0
        BNE      ??Toggle_Mic_2
        ADR      R1,??DataTable23  ;; 0x4F, 0x4B, 0x00, 0x00
        B        ??Toggle_Mic_3
??Toggle_Mic_2:
        LDR      R1,??DataTable29_15
??Toggle_Mic_3:
        MOVS     R2,R5
        ANDS     R2,R2,#0xFF      ;; Zero extend
        LDR      R0,??DataTable29_16
        BL       BSP_Ser_Printf
        MOVS     R0,R5
        ANDS     R0,R0,#0xFF      ;; Zero extend
        CMP      R0,#+0
...
Set_Volume:
        PUSH     {R4-R6,LR}
        MOVS     R4,R0
        LDR      R0,??DataTable29_17
        BL       BSP_Ser_Printf
        LDR      R0,[R4, #+0]
        CMP      R0,#+1000
        BNE      ??Set_Volume_0
        LDR      R0,??DataTable29_18
        BL       BSP_Ser_Printf
        B        ??Set_Volume_1
??Set_Volume_0:
        LDR      R1,[R4, #+0]
        LDR      R0,??DataTable29_19
        BL       BSP_Ser_Printf
??Set_Volume_1:
        LDR      R0,[R4, #+4]
        CMP      R0,#+1000
        BNE      ??Set_Volume_2
        LDR      R0,??DataTable29_20
        BL       BSP_Ser_Printf
        B        ??Set_Volume_3
??Set_Volume_2:
        LDR      R0,[R4, #+4]
        ...
        MOVS     R1,R0
        MOVS     R2,R6
        LDR      R0,??DataTable29_21
        BL       BSP_Ser_Printf
??Set_Volume_3:
        LDR      R0,[R4, #+8]
        CMP      R0,#+1000
        BNE      ??Set_Volume_4
        LDR      R0,??DataTable29_22
        BL       BSP_Ser_Printf
        B        ??Set_Volume_5
??Set_Volume_4:
        LDR      R0,[R4, #+8]
...
??Ruler_Port_LED_Service_8:
        ...
        CMP      R0,#+0
        BNE      ??Ruler_Port_LED_Service_4
        LDR      R0,??DataTable29_28
        LDR      R0,[R0, #+0]
        ADDS     R1,R0,#+1
        LDR      R2,??DataTable29_28
        STR      R1,[R2, #+0]
        CMP      R0,#+6
...
AB_POST:
        PUSH     {R4,LR}
        LDR      R0,??DataTable29_29
        BL       BSP_Ser_Printf
        BL       Enable_FPGA
        LDR      R0,??DataTable29_30
        BL       BSP_Ser_Printf
        MOV      R0,#+32000
        BL       Init_CODEC
        MOVS     R4,R0
        ...
        BEQ      ??AB_POST_0
        MOV      R0,#+195
        LDR      R1,??DataTable29_26
        STRB     R0,[R1, #+0]
        MOVS     R1,R4
        ANDS     R1,R1,#0xFF      ;; Zero extend
        LDR      R0,??DataTable29_31
        BL       BSP_Ser_Printf
        B        ??AB_POST_1
??AB_POST_0:
        LDR      R0,??DataTable29_32
        BL       BSP_Ser_Printf
        LDR      R0,??DataTable29_33
        BL       BSP_Ser_Printf
        MOV      R3,#+0
        MOV      R2,#+1
        MOV      R1,#+0
...
simple_test_use:
        ...
        LDR      R1,??DataTable29_10
        STRB     R0,[R1, #+0]
        LDR      R0,??DataTable29_39
        LDM      R0,{R2,R3}
        ADD      R0,SP,#+8
        STM      R0,{R2,R3}
        LDR      R0,??DataTable29_40
        LDM      R0,{R2,R3}
        MOVS     R0,SP
        STM      R0,{R2,R3}
        ADD      R0,SP,#+8
...
Ruler_Setup_Sync:
        ...
        MOVS     R4,R0
        ADD      R0,SP,#+16
        LDR      R1,??DataTable29_41
        LDR      R2,[R1, #0]
        STR      R2,[R0, #+0]
        LDR      R0,??DataTable29_42
        LDRB     R0,[R0, #+0]
        STRB     R0,[SP, #+17]
        STRB     R4,[SP, #+18]
        MOVS     R0,R4
...
??Ruler_Setup_Sync_0:
        ADD      R2,SP,#+12
        MOV      R1,#+0
        LDR      R0,??DataTable29_43
        LDR      R0,[R0, #+0]
        BL       OSSemPend
        LDR      R0,??DataTable29_44
        LDRB     R0,[R0, #+0]
        ANDS     R4,R4,#0xFF      ;; Zero extend
        CMP      R0,R4
...
??Ruler_Setup_Sync_2:
        ...
        MOVS     R1,R4
        ANDS     R1,R1,#0xFF      ;; Zero extend
        LDR      R0,??DataTable29_47
        BL       BSP_Ser_Printf
        B        ??Ruler_Setup_Sync_5
??Ruler_Setup_Sync_4:
        LDR      R0,??DataTable29_48
        LDRB     R0,[R0, #+0]
        STRB     R0,[SP, #+12]
        LDRB     R0,[SP, #+12]
        CMP      R0,#+0
...
//  2 742 bytes in section .rodata
// 10 204 bytes in section .text
// 
// 10 204 bytes of CODE  memory
//  2 742 bytes of CONST memory
