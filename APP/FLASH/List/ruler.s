...
??Save_Ruler_FW_0:
        ...
        B        ??Save_Ruler_FW_4
??Save_Ruler_FW_3:
        ADR      R0,??DataTable22_1  ;; 0x3E, 0x20, 0x00, 0x00
        BL       BSP_Ser_Printf
        LDR      R0,[SP, #+0]
        CMP      R0,#+170
        BEQ      ??Save_Ruler_FW_5
...
??Ruler_Setup_Sync_2:
        ...
        MOVS     R1,R4
        ANDS     R1,R1,#0xFF      ;; Zero extend
        LDR      R0,??DataTable31_48
        BL       BSP_Ser_Printf
        B        ??Ruler_Setup_Sync_5
??Ruler_Setup_Sync_4:
        LDR      R0,??DataTable31_49
        LDRB     R0,[R0, #+0]
        STRB     R0,[SP, #+12]
        LDRB     R0,[SP, #+12]
        CMP      R0,#+0
...
`?<Constant "WARN:(Setup_Audio Pla...">`:
        DATA
        DC8 "WARN:(Setup_Audio Play)pAudioCfg->channels =  0\015\012"
        DC8 0, 0
...
`?<Constant "WARN:(Setup_Audio Rec...">_1`:
        ...
        DC8 69H, 6EH, 20H, 3DH, 20H, 20H, 30H, 0DH
        DC8 0AH, 0
        DC8 0, 0
...
`?<Constant "Revert DMIC polarity ...">`:
        DATA
        DC8 "Revert DMIC polarity for W01.\015\012"

        SECTION `.rodata`:CONST:REORDER:NOROOT(2)
`?<Constant "\\r\\nDMIC_Ploarity_Contr...">`:
        DATA
        DC8 "\015\012DMIC_Ploarity_Control ERROR: %d\015\012"
