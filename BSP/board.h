...
////////////////////////////////////////////////////////////////////////////////
//                 iSAM Ruler Audio Bridge Board V1.0 Defines
////////////////////////////////////////////////////////////////////////////////
#define BUZZER            {1 <<  4, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_OUTPUT_1, PIO_DEFAULT}
#define UART1_SEL0        {1 <<  5, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_OUTPUT_0, PIO_DEFAULT}//ruler  uart selector
#define UART1_SEL1        {1 <<  6, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_OUTPUT_0, PIO_DEFAULT}
#define UART2_SEL0        {1 << 11, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_OUTPUT_0, PIO_DEFAULT}//audio  uart selector
#define UART2_SEL1        {1 << 12, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_OUTPUT_0, PIO_DEFAULT}    

#define FPGA_CS           {1 << 14, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_OUTPUT_1, PIO_DEFAULT}
#define FPGA_DAT          {1 << 16, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_OUTPUT_1, PIO_DEFAULT}
#define FPGA_CLK          {1 << 17, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_OUTPUT_1, PIO_DEFAULT}  
                     
#define PORT_DETECT0      {1 << 18, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_INPUT, PIO_PULLUP} //ruler insert detect: pull low trigger level interruption
#define PORT_DETECT1      {1 << 19, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_INPUT, PIO_PULLUP} 
#define PORT_DETECT2      {1 << 20, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_INPUT, PIO_PULLUP} 
#define PORT_DETECT3      {1 << 21, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_INPUT, PIO_PULLUP}    
#define PORT_LED0         {1 << 22, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_OUTPUT_1, PIO_DEFAULT}// ruler port stauts port, default off                
#define PORT_LED1         {1 << 23, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_OUTPUT_1, PIO_DEFAULT}
#define PORT_LED2         {1 << 24, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_OUTPUT_1, PIO_DEFAULT}
#define PORT_LED3         {1 << 25, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_OUTPUT_1, PIO_DEFAULT}
...
//GPIO controls
#define GPIO_PDM_OE       {1 << 24, AT91C_BASE_PIOB, AT91C_ID_PIOB, PIO_OUTPUT_0, PIO_PULLUP} //FPGA control
#define GPIO_PWR_CTR      {1 << 25, AT91C_BASE_PIOB, AT91C_ID_PIOB, PIO_OUTPUT_0, PIO_PULLUP} //ruler 3.3V(D&A)power switch: default power off
#define GPIO_SPK_OFF      {1 << 26, AT91C_BASE_PIOB, AT91C_ID_PIOB, PIO_OUTPUT_1, PIO_PULLUP} //PA enable
...
#define LED_P2       4  
#define LED_P3       5                       
#define PINS_LEDS    LED1, LED2, PORT_LED0, PORT_LED1, PORT_LED2, PORT_LED3
