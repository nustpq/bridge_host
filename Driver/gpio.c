...
static Pin pinsGpios[]  = {   
    ...
    UART1_SEL0,   UART1_SEL1,   UART2_SEL0,   UART2_SEL1, // 0 ~ 3
    GPIO_PDM_OE,  GPIO_PWR_CTR, GPIO_SPK_OFF, GPIO_AUDIO_RST, GPIO_FM_RST, // 4 ~ 8
    PORT_DETECT0, PORT_DETECT1, PORT_DETECT2, PORT_DETECT3, // 9 ~ 12 
    LED1,         LED2, // 13 ~ 14
    PORT_LED0,    PORT_LED1,    PORT_LED2,    PORT_LED3, // 15 ~18
    BUZZER,       FPGA_CS,      FPGA_DAT,     FPGA_CLK    // 19 ~ 22
